...
-------------------------
  ...
  4. Re-run the dry-run. When the contract check says PASS, run the pipeline.
...
---------------------------------------
  ...
  - Units. Current in mA rather than A, travel in metres rather than mm. The
    pipeline is scale-free after per-asset baselining, but the aspect
    thresholds and the failure threshold are learned - so units only matter for
    reading the numbers aloud. Note them, do not fight them.
